...
EOF
	...
	git clone https://github.com/crosserR/trojan-panel.git
	cd trojan-panel
	composer install
	npm install
	rm -rf /var/www/trojan-panel/.env
	wget https://raw.githubusercontent.com/crosserR/Trojan_Pannel_Script/master/.env
	...
	wget -P /etc/nginx/sites-available https://raw.githubusercontent.com/crosserR/Trojan_Pannel_Script/master/default
	...
	wget -P /etc/nginx https://raw.githubusercontent.com/crosserR/Trojan_Pannel_Script/master/nginx.conf
